---
title: "Introduction to Wavelet Core Inflation"
author: "Nelson Silva"
date: "`r Sys.Date()`"
output: 
...
The main goal of this vignette is to construct an example showing how a wavelet core inflation measure can be obtained by wavcoreinf package. Then, this wavelet core is compared with others tranditional core inflation measures. The data are the same as in the database coreinf_br. This database contains headline inflation and core inflation measure for the Brazilian economy. The example is based on empirical Bayes thresholding on the levels of a wavelet transform methdod available in R package EbayesThresh. Measures based on others methods can be constructed in the same way.
...
Statistics for Evaluation of the wavelet core inflation, h = 3 and k = 15 just for fasting computation. More realistic h and k would be 12 and 24, respectively.
...
Tibble with headline inflation, tradional and wavelet core inflation
